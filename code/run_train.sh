...
python code/train.py --model_name_or_path $ENCODER --output_dir $OUTPUT_DIR --pretrained_cache_dir ./pretrained --batch_size 8 --lr 5e-5 --max_epoches 20 --max_steps 20000 --warmup_steps 100 --num_workers 1 --gpu_id 1
